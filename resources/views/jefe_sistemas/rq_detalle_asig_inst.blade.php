...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Detalle de Asignación.</h1>
    ...
    <div class="card-body">
          <div class="row">
                ...
                <div class="col-lg-4 text-left">  
                   <strong>{{ $detalle[0]->id_asig_instal }}</strong>
                </div>
                <div class="col-lg-2">  
                    Accesible
                </div>
                <div class="col-lg-4 text-left">  
                   <strong>{{ $detalle[0]->id_gestor }}</strong>
                </div>
          </div>
          <div class="row">
                  <div class="col-lg-2">  
            ...
            <div class="row">
                  ...
                  <div class="col-lg-4 text-left">  
                     <strong>{{ $detalle[0]->fecha_asig_instal }}</strong>
                  </div>
                  <div class="col-lg-2">  
                      Hora Solicitud
                  </div>
                  <div class="col-lg-4 text-left">  
                     <strong>{{ $detalle[0]->hora_asig_instal }}</strong>
                  </div>
            </div>
            <div class="row">
                  <div class="col-lg-2">  
            ...
            <br>
             <form class="md-form" id="logout-form2" action="{{ url('/JefeSistemas/'.$id .'/rq-guardar-instalar') }}" method="post" enctype="multipart/form-data">
               {{ csrf_field() }}
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 text-left"> 
                  <textarea class="form-control" rows="4" id="comment"  name="text" disabled="disabled">{{ $detalle[0]->desc_solu }}</textarea> 
                  </div>
                </div><br><br>
                <div class="row">
                <div class="col-lg-2">  
        ...
        <div class="modal-footer">
          ...
          <!--<a class="btn btn-primary" href="login.html">Logout</a>-->
              ...
              <form id="logout-form2" action="{{ route('detalleAprob','id') }}" method="POST" style="display: none;">
                  {{ csrf_field() }}
                  <input type="hidden" name="id" value="{{ $detalle[0]->id_asig_instal }}">
              </form>
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="form-group">
         <div class="modal-body">Observación del rq {{ $detalle[0]->id_asig_instal }}.</div>
