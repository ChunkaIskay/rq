...
es: "Elegir"
 ...
 <!-- Begin Page Content -->
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Revisar requerimientos Certificados.</h1>
  <p class="mb-4">Datos de la Certficación del Requerimiento.</p>

  <!-- DataTales Example -->
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary">Datos del Requerimiento.
      </h6>
    </div>
    <div class="card-body">
          <div class="row">
                ...
                <div class="col-lg-4 text-left">  
                   <strong>{{ $detalle[0]->cert_acces }}</strong>
                </div>
          </div>
          <div class="row">
                  <div class="col-lg-2">  
            ...
            <br>
             <form class="md-form" id="logout-form2" action="{{ url('/JefeSistemas/'.$id .'/rq-guardar-cert') }}" method="post" enctype="multipart/form-data">
               {{ csrf_field() }}
                ...
                <div class="col-lg-2 text-left">
                    ...
                    <input type="hidden" name="id_solucion" value="{{ $detalle[0]->id_solucion }}">
                </div>
                <div class="col-lg-2">  
                   para Desarrollador:
                </div>
            ...
            <!--  {{ $url1 = $nombreCarpeta.'.subir_adjunto'}} -->
            @include($url1)
            ...
            <div class="row">
              <div class="col-lg-6 text-right">  
                ...
                <a href="#" class="btn btn-success btn-icon-split" data-toggle="modal" data-target="#logoutModalApro">
                  ...
                  <span class="text">Asignar requerimiento</span>
                </a>
              </div>
              <div class="col-lg-6"> 
                 <div class="my-2"></div>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="collapse show" id="datosSolu">
           <div class="card-body">
            ...
            <br>
            <!--  {{ $url2 = $nombreCarpeta.'.subir_adjunto1'}} -->
...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <a href="#certiPre" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="certiPre">
          <h6 class="m-0 font-weight-bold text-primary">Datos de certificación </h6>
        </a>
        <!-- Card Content - Collapse -->
        <div class="collapse show" id="certiPre">
           <div class="card-body">
            ...
            <br>
            <!--  {{ $url3 = $nombreCarpeta.'.subir_adjunto2'}} -->
            @include($url3)
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="logoutModalApro">Esta seguro de asignar el requerimiento al desarrollador.</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">x</span>
          </button>
        </div>
        <div class="modal-body">Seleccione "Asignar Requerimiento" para asignar el  rq {{ $detalle[0]->id_requerimiento }}.</div>
