              ...
              <div class="table-responsive">
                ...
                @foreach($rqexaminar as $key => $value) 
                  <tr class="table">
                      ...
                      @if($pag == 'prioridad')
                          <a href="{{ url('/JefeSistemas/'.$value->id_requerimiento.'/rq-prioridad-editar') }}" 
                                type="button" rel="tooltip" title="Editar Req." class="btn btn-info btn-simple btn-xs">
                          <i class="far fa-edit"></i>
                          </a>
                      @else
                          <a href="{{ url('/JefeSistemas/'.$value->id_requerimiento.'/rq-examinar-detalle') }}" type="button" rel="tooltip" title="Ver detalle" class="btn btn-success btn-simple btn-xs">
                          <i class="fa fa-eye"></i></a>
                          <a href="{{ url('/JefeSistemas/'.$value->id_requerimiento.'/rq-modificar') }}" 
                                type="button" rel="tooltip" title="Editar Req." class="btn btn-info btn-simple btn-xs">
                           <i class="far fa-edit"></i>
                           </a>
                      @endif
