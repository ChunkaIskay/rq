	...
	<div class="card-body">
		...
		<div class="tab-content" id="myTabContent">
			...
			<div class="tab-pane fade {{ $activo['aprobado']['show_active'] }}" id="aprobados" role="tabpanel" aria-labelledby="aprobados-tab">
				<div class="card-body">
					<form action="{{ url('/JefeSistemas/rq-estado-all') }}"  method="post"  enctype="multipart/form-data" class="navbar-form navbar-left" >
						 {{ csrf_field() }}
				 ...
				 @include('jefe_sistemas.list_aprobado')
			</div>
			<!---asignado---->
			<div class="tab-pane fade {{ $activo['asignado']['show_active'] }}" id="asignados" role="tabpanel" aria-labelledby="asignados-tab">
				<div class="card-body">
					<form action="{{ url('/JefeSistemas/rq-estado-all-asig') }}"  method="post"  enctype="multipart/form-data" class="navbar-form navbar-left" >
						 {{ csrf_field() }}
						<h4>Presisione el boton 'Ver listados'.!</h4>
				...
				@include('jefe_sistemas.list_asignado')
			</div>
			<!---desarrollo---->
			<div class="tab-pane fade {{ $activo['desarrollo']['show_active'] }}" id="desarrollo" role="tabpanel" aria-labelledby="desarrollo-tab">
				<div class="card-body">
					<form action="{{ url('/JefeSistemas/rq-estado-all-desa') }}"  method="post"  enctype="multipart/form-data" class="navbar-form navbar-left" >
						 {{ csrf_field() }}
						<h4>Presisione el boton 'Ver listados'.!</h4>
				...
				@include('jefe_sistemas.list_desarrollo')
			</div>
			<!---pruebas---->
			<div class="tab-pane fade {{ $activo['pruebas']['show_active'] }}" id="pruebas" role="tabpanel" aria-labelledby="pruebas-tab">
				<div class="card-body">
					<form action="{{ url('/JefeSistemas/rq-estado-all-pruebas') }}"  method="post"  enctype="multipart/form-data" class="navbar-form navbar-left" >
						 {{ csrf_field() }}
						<h4>Presisione el boton 'Ver listados'.!</h4>
				...
				@include('jefe_sistemas.list_pruebas')
			</div>
			<!---instalacion---->
			<div class="tab-pane fade {{ $activo['instalacion']['show_active'] }}" id="instalacion" role="tabpanel" aria-labelledby="instalacion-tab">
				<div class="card-body">
					<form action="{{ url('/JefeSistemas/rq-estado-all-inst') }}"  method="post"  enctype="multipart/form-data" class="navbar-form navbar-left" >
						 {{ csrf_field() }}
						<h4>Presisione el boton 'Ver listados'.!</h4>
				...
				@include('jefe_sistemas.list_instalacion')
			</div>
			<!---certificado---->
			<div class="tab-pane fade {{ $activo['certificado']['show_active'] }}" id="certificado" role="tabpanel" aria-labelledby="certificado-tab">
				<div class="card-body">
					<form action="{{ url('/JefeSistemas/rq-estado-all-cert') }}"  method="post"  enctype="multipart/form-data" class="navbar-form navbar-left" >
						 {{ csrf_field() }}
						<h4>Presisione el boton 'Ver listados'.!</h4>
						<button type="submit" class="btn btn-info">
							<span >Ver listado</span>
				...
				@include('jefe_sistemas.list_certificacion')
			</div>
		</div>
