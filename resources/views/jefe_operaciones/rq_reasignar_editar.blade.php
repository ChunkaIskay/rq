...
<div class="container-fluid">
  ...
  <p class="mb-4">Para reasignar el requerimiento a otro operador, dirijase al campo "Seleccione nuevo operador" .</p>
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form  class="md-form" id="logout-form2" action="{{ url('/JefeOperaciones/'.$detalle[0]->id_requerimiento .'/rq-reasignar-actualizar') }}" method="post" enctype="multipart/form-data">
         {{ csrf_field() }}
          <div class="row">
                <div class="col-lg-3">  
                   Id Requerimiento
          ...
          <div class="row">
                ...
                <div class="col-lg-3 text-left">  
                   <select class="form-control"  name="id_ope" required="">
                     @foreach($operador as $keyp => $vope) 
                              <option value="{{ $vope->id }}" @if( $vope->id == old('id_ope', $detalle[0]->id_operador )) selected @endif>{{ $vope->name.' '.$vope->ap_paterno }}</option>
                     @endforeach
                  </select>
                </div>
                <div class="col-lg-3">  
          ...
          <div class="row">
                ...
                <textarea class="form-control" rows="4" id="descripcion" placeholder="Modifique la descripcion" name="descripcion" disabled="">{{ $detalle[0]->descripcion }}</textarea>  
                   <strong></strong>
                </div>
          </div> <br>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-lg-6"> 
               <div class="my-2"></div>
               <a class="btn btn-primary" href="{{ route('rqReasignar') }}">
                <span class="icon text-white-50">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Esta seguro de reasinar el requeremiento.</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">x</span>
          </button>
        </div>
        <div class="modal-body">Se asignará el requerimeinto a otro operador.</div>
