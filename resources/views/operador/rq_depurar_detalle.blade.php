...
<div class="container-fluid">
  ...
  <br><br>
  <form  class="md-form" id="logout-form3" action="{{ url('/Operador/'.$detalle[0]->id_requerimiento .'/rq-depurar-guardar') }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
           @if($errors->any())
            <div class="alert alert-danger">
              <ul>
  ...
  <div class="row">
        ...
        <div class="col-lg-6"> 
           <div class="my-2"></div>
            ...
            <a class="btn btn-primary" href="{{ route('rqDepurarRequeriemto') }}">
                <span class="icon text-white-50">
