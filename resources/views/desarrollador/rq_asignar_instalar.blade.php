...
@section('content')
 <!-- Begin Page Content -->
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
               <div class="container">
                  <form action="{{ route('searchRevAsignarInst') }}"  method="post"  enctype="multipart/form-data" class="navbar-form navbar-left" >
                     {{ csrf_field() }}
                  ...
                  @foreach($rqAsigIstalar as $key => $value) 
                      <tr class="table">
                          ...
                          <td class="td-actions text-right">
                                <a href="{{ url('/Desarrollador/'.$value->id_asig_instal.'/rev-detalle-asig-inst') }}" type="button" rel="tooltip" title="Asignar req. a instalar" class="btn btn-info btn-simple btn-xs">
