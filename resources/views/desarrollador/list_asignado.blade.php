	  ...
	  <div class="collapse show" id="asig">
        ...
        @endif
	 	...
	 	<span class="table-responsive border border-success"  id="div2" ondrop="drop(event)" ondragover="allowDrop(event)">
			...
			<div onmouseover="bigImg(this)" onmouseout="normalImg(this)" class="table-responsive border border-danger"  id="div3" ondrop="drop(event)" ondragover="allowDrop(event)">
			 		@if(!empty($rqPrueba))	
...
/*
  ...
  numero = obj.getElementsByTagName('div').length;
	...
	{
	//	timeout = 'timeout_'+id_rq;
		// obteneos la fecha actual
		var actual = new Date().getTime();
	
		//var fecha_actual = new Date();
		var actuall = new Date(actual);
	//	console.log(' actual:'+actuall);
	//	console.log(' horas_inicial:'+horas_inicial);
	...
	//	var result=LeadingZero(horass)+":"+LeadingZero(minutoss)+":"+LeadingZero(segundoss);
...
function desactivar(){  alert(counter);
...
//		 		document.getElementById("myTextarea").value
		 ...
		 console.log(' id_reqq :'+id_reqq);
		 console.log(' text desd :'+texto_desc);
		 console.log(' text cliente :'+texto_cliente);
		 console.log(' text  serv :'+texto_servidores);
