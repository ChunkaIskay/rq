          ...
          <div class="row">
            ...
            <div class="col-lg-6 text-right">  
                ...
                <a href="#" class="btn btn-success btn-icon-split" data-toggle="modal" data-target="#textoModal_{{ $value1->id_requerimiento }}">
                  ...
                  <span class="text">Registrar Control de Versiones</span>
                </a>
              </div>
              <div class="col-lg-6 text-left">  
                <div class="my-2"></div>
                  <a class="btn btn-primary" href="{{ route('revListarControlVerPendientes') }}">
                  Cerrar ventana
                  </a>
              </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modalLabel_{{ $value1->id_requerimiento }}">Datos del requerimiento {{ $value1->id_requerimiento }} que registrara el control de la versión.</h5>
        ...
        <div class="modal-body">
              <form id="logout-form1_{{ $value1->id_requerimiento }}" action="{{ route('guadarControlVerPen', $value1->id_requerimiento ) }}" method="POST" >
                  {{ csrf_field() }}
