                ...
                @foreach($seguimientoRq as $key => $value) 
                    <tr class="table">
                        ...
                        <td class="td-actions text-right">
                                <a href="{{ url('/Verificador/'.$value->id_requerimiento.'/rq-seguimiento') }}" type="button" rel="tooltip" title="Seguimiento a este requerimiento" class="btn btn-info btn-simple btn-xs">
