...
@section('content')
 <!-- Begin Page Content -->
          ...
          @if(session('error'))
            ...
            @endif
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Listado de Requerimientos</h1>
              ...
              <div class="table-responsive">
                ...
                @foreach($rqexaminar as $key => $value) 
                  <tr class="table">
                      ...
                      @else
                          <a href="{{ url('/Verificador/'.$value->id_requerimiento.'/req-detalle') }}" type="button" rel="tooltip" title="Ver detalle" class="btn btn-success btn-simple btn-xs">
