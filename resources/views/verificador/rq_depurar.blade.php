...
@section('content')
 <!-- Begin Page Content -->
          ...
          @if(session('error'))
            ...
            @endif
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Depurar Requerimientos.</h1>
          <p class="mb-4">Detalle del Requerimiento a Depurar.</p>
                ...
                @foreach($seguimientoRq as $key => $value) 
                    <tr class="table">
                        ...
                        <td class="td-actions text-right">
                                <a href="{{ url('/Verificador/'.$value->id_requerimiento.'/rq-depurar-detalle') }}" type="button" rel="tooltip" title="Seguimiento a este requerimiento" class="btn btn-info btn-simple btn-xs">
