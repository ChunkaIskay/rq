  ...
  <div class="row">
        ...
        <div class="card shadow mb-4" id="target_1" style="display: none;">
            ...
            <div class="card-body">
                  ...
                  <br>
                  <br>
                  @include('arch_adjuntos.subir_adjunto3')
                  <div class="row">
        ...
        <div class="card shadow mb-4" id="target_4" style="display: none;">
            ...
            <div class="card-body">
                  ...
                  <br>
                  <br>
                  @include('arch_adjuntos.subir_adjunto4')
                  <div class="row">
                      <div class="col-lg-12 text-center"> 
                         <div class="my-2"></div>
                        <a id="ocultar_0" onclick="showDiv('ocultar', 0 )"  style="cursor:pointer;" class="btn btn-danger btn-icon-split" data-toggle="modal" >
        ...
        <div class="card shadow mb-5" id="target_5" style="display: none;">
            ...
            <div class="card-body">
                  ...
                  <br>
                  <br>
                  @include('arch_adjuntos.subir_adjunto5')
                  <div class="row">
                      <div class="col-lg-12 text-center"> 
                         <div class="my-2"></div>
                        <a id="ocultar_0" onclick="showDiv('ocultar', 0 )"  style="cursor:pointer;" class="btn btn-danger btn-icon-split" data-toggle="modal" >
        ...
        <div class="card shadow mb-5" id="target_6" style="display: none;">
            ...
            <div class="card-body">
                  ...
                  <br>
                  <br>
                  @include('arch_adjuntos.subir_adjunto6')
                  <div class="row">
                      <div class="col-lg-12 text-center"> 
                         <div class="my-2"></div>
                        <a id="ocultar_0" onclick="showDiv('ocultar', 0 )"  style="cursor:pointer;" class="btn btn-danger btn-icon-split" data-toggle="modal" >
        ...
        <div class="card shadow mb-5" id="target_7" style="display: none;">
            ...
            <div class="card-body">
                  ...
                  <br>
                  <br>
                  @include('arch_adjuntos.subir_adjunto7')
                  @include('arch_adjuntos.subir_adjunto8')
                  <div class="row">
                      <div class="col-lg-12 text-center"> 
                         <div class="my-2"></div>
                         <a id="ocultar_0" onclick="showDiv('ocultar', 0 )"  style="cursor:pointer;" class="btn btn-danger btn-icon-split" data-toggle="modal" >
        ...
        <div class="card shadow mb-5" id="target_8" style="display: none;">
            ...
            <div class="card-body">
                  ...
                  <br>
                  <br>
                  @include('arch_adjuntos.subir_adjunto9')
                  <div class="row">
                      <div class="col-lg-12 text-center"> 
                         <div class="my-2"></div>
                         <a id="ocultar_0" onclick="showDiv('ocultar', 0 )"  style="cursor:pointer;" class="btn btn-danger btn-icon-split" data-toggle="modal" >
        ...
        <div class="row">
          ...
          <div class="col-lg-6"> 
            <a class="btn btn-primary" href="{{ route('seguimientoVeri') }}">
                <span class="icon text-white-50">
                  <i class="fas fa-exclamation-triangle"></i>
                </span>
