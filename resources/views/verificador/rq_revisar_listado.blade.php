...
@section('content')
 <!-- Begin Page Content -->
          ...
          @if(session('error'))
            ...
            @endif
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Revisar requerimientos</h1>
          <p class="mb-4">Lista de requerimientos para aprobación.</p>
          <!-- progress bar -->
          <div class="progress">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Lista de equerimientos para aprobación</h6>
            </div>
              ...
              <div class="table-responsive">
                ...
                @foreach($rqexaminar as $key => $value) 
                  <tr class="table">
                      ...
                      @if($pag == 'prioridad')
                          <a href="{{ url('/Verificador/'.$value->id_requerimiento.'/rq-prioridad-editar') }}" 
                                type="button" rel="tooltip" title="Editar Req." class="btn btn-info btn-simple btn-xs">
                          <i class="far fa-edit"></i>
                          </a>
                      @else
                          <a href="{{ url('/Verificador/'.$value->id_requerimiento.'/rq-revisar-detalle') }}" type="button" rel="tooltip" title="Ver detalle" class="btn btn-success btn-simple btn-xs">
